...
## Read Input Table
IncrementalInputDyF = glueContext.create_dynamic_frame.from_catalog(database = "iceberg_demo", table_name = "transactions_input", transformation_ctx = "IncrementalInputDyF")
...
if not IncrementalInputDF.rdd.isEmpty():
    ...
    MERGE INTO job_catalog.iceberg_demo.transactions_output t
    USING (
        SELECT 
            cdc_operation, 
            id, 
